...
export function Data(){
    return(
        <div>
            <div className="home__data mt-5 ms-4">
                ...
                <h3 className="home__subtitle ms-5">
                   (Web Developer)
                </h3>
                <br></br>
                <p className="home__description">I am a web developer with over 1-2 years of experience building intuitive and responsive user interfaces.</p>
                <a href="#contact" className="button button--flex"  style={{textDecoration:'none'}}><button className="btn btn-dark uil uil-message" style={{color:'white'}}>Say Hello</button>
                    <svg
